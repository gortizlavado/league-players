INSERT INTO player (id, name, lastname, surname, date_birthday, player_position, team, status, created_at, updated_at, deleted_at)
...
INSERT INTO player (name, lastname, surname, date_birthday, player_position, team, status)
VALUES ('name3', 'lastname3', 'surname3', '1989-06-23', 0, 0, 0);

INSERT INTO stat (season_id, player_id, points, match_played, goals, goals_conceded, goals_penalty, yellow_cards, double_yellow_cards, red_cards)
